...
CKEDITOR.editorConfig = function( config ) {
	...
	config.filebrowserFlashUploadUrl = "/static/ckeditor/flash"
	config.imageUploadUrl  = "/static/ckeditor/img"
...
//  config.toolbar = 'Full';
    config.toolbar_Basic = [
      ...
      { name: 'insert', items: [ 'Image', 'Flash', 'EmbedSemantic', 'Table' ] },
...
//  CKEDITOR.replace( 'myfiled', { customConfig : './config.js' } );
 //界面编辑框的背景色 plugins/dialog/plugin.js
    ...
    config.entities_processNumerical = false;
     //添加新组件
    config.extraPlugins = 'preview,colorbutton,myAddImage'; //非默认 仅示例
...
//  config.protectedSource.push( /(]+>["s|"S]*?<"/asp:[^">]+>)|(]+"/>)/gi );   // ASP.Net Code
    ...
    config.shiftEnterMode = CKEDITOR.ENTER_DIV;  //可选：CKEDITOR.ENTER_BR或CKEDITOR.ENTER_DIV
    ...
    config.smiley_path = 'static/ckeditor/plugins/smiley/images/';
...
//  config.stylesCombo_stylesSet = 'mystyles:http://www.example.com/editorstyles/styles.js';
  ...
  // 移除不需要的模块
  // config.removePlugins = 'elementspath,Source';
